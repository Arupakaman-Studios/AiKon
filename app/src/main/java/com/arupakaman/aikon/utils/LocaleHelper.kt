...
object LocaleHelper {
    ...
    fun onAttach(mContext: Context, defaultLanguage: String? = null, defaultLanguageName: String? = null): Context {
        val mPrefs = AikonSharedPrefs.getInstance(mContext)
    ...
    fun getSelectedLanguageCodePosition(mContext: Context): Int{
        kotlin.runCatching {
            ...
            val pos = langCodes.indexOf(AikonSharedPrefs.getInstance(mContext).selectedLanguageCode)
